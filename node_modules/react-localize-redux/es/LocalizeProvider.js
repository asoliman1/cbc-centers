...
import 'redux';
import { localizeReducer, getActiveLanguage, getOptions, getTranslationsForActiveLanguage } from './localize';
...
export var LocalizeProvider = function (_Component) {
  ...
  _createClass(LocalizeProvider, [{
    ...
    value: function onStateDidChange(prevState) {
      ...
      var prevLocalizeState = prevState && prevState.localize;
      var curLocalizeState = this.props.store.getState().localize;
