...
class Course_faqs extends Component {
    ...
    render() {
        return (
            ...
            <a  title="click here" onClick={()=>{this.setState({a:'block'})}} >Lorem ipsum dolor sit tempor vehicula ipsum nec?</a>
            <ul style={{display:this.state.a}} className="animated fadeInUp" >
